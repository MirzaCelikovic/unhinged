  ...
  return (
    <View className="flex-1 bg-background">
      ...
      <View className="flex-1 p-4">
        ...
        <View className="mt-4">
          <Text className="mb-3 font-roboto-bold text-lg text-black">{t('notificationsSettings.title')}</Text>
          <View className="overflow-hidden rounded-2xl bg-white">
            <View className="flex-row items-center justify-between border-b border-gray-100 p-4">
              <Text className="flex-1 font-roboto-medium text-base text-gray-900">
                {t('notificationsSettings.tracked')}
              </Text>
              <Switch
            ...
            <View className="flex-row items-center justify-between border-b border-gray-100 p-4">
              <Text className="flex-1 font-roboto-medium text-base text-gray-900">
                {t('notificationsSettings.account')}
              </Text>
              <Switch
            ...
            <View className="flex-row items-center justify-between p-4">
              <Text className="flex-1 font-roboto-medium text-base text-gray-900">
                {t('notificationsSettings.marketing')}
              </Text>
              <Switch
