...
export default function TrackingAccount() {
  ...
  const handleStopTracking = () => {
    ...
    Alert.alert(
      ...
      t('stopTracking.confirm', { username: instagram?.username || username }),
      [
        { text: t('stopTracking.cancel'), style: 'cancel' },
        {
          text: t('stopTracking.confirmCta'),
          style: 'destructive',
          onPress: async () => {
            try {
              ...
              Alert.alert(t('stopTracking.errorTitle'), t('stopTracking.errorMessage'));
            }
          },
        },
      ]
            ...
            {activeTab === 'settings' && (
              <View className="overflow-hidden rounded-2xl bg-white">
                <View className="border-b border-gray-100 p-4">
                  ...
                  {followingWarn && (
                    <Text className="mt-2 font-roboto-regular text-sm text-gray-400">
                      {t('syncSettings.rateLimitWarning')}
                    </Text>
                  )}
                </View>
                <View className="border-b border-gray-100 p-4">
                ...
                <Pressable
                  ...
                  <Text className="font-roboto-medium text-base text-error">{t('syncSettings.stopTracking')}</Text>
                </Pressable>
              </View>
            )}
          </View>
