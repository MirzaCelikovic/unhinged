...
const FEATURE_KEYS = [
  'comparison.feature.trackPrivate',
  'comparison.feature.encryptedConnection',
  'comparison.feature.redFlag',
  'comparison.feature.thirstTrap',
  'comparison.feature.followBack',
];
      ...
      <View className="flex-1 justify-center">
        ...
        <View className="mb-4 flex-row items-center">
          <View className="flex-1">
            <Text className="font-roboto-bold text-xl">{t('comparison.header.feature')}</Text>
          </View>
          <View className="w-20 items-center">
            <Text className="font-roboto-bold text-xl">{t('comparison.header.other')}</Text>
          </View>
