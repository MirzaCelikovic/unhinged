...
const FEATURES = [
  i18n.t('onboarding.comparison.features.trackPrivateUsers'),
  i18n.t('onboarding.comparison.features.encryptedIgConnection'),
  i18n.t('onboarding.comparison.features.identifyRedFlagBehavior'),
  i18n.t('onboarding.comparison.features.thirstTrapWarnings'),
  i18n.t('onboarding.comparison.features.followerFollowBackAlerts'),
];
...
export default function ComparisonScreen({ onNext }: ComparisonScreenProps) {
  ...
  return (
    <View className="flex-1 px-4">
      ...
      <View className="flex-1 justify-center">
        ...
        <View className="mb-4 flex-row items-center">
          <View className="flex-1">
            <Text className="font-roboto-bold text-xl">{t('onboarding.comparison.featureHeader')}</Text>
          </View>
          <View className="w-20 items-center">
            <Text className="font-roboto-bold text-xl">{t('onboarding.comparison.otherHeader')}</Text>
          </View>
      ...
      <View className="pb-8">
        <Button label={t('onboarding.comparison.continue')} onPress={() => {
