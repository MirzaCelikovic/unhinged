...
export default function ComparisonScreen({ onNext }: ComparisonScreenProps) {
  ...
  const FEATURES = [
    t('onboarding.comparison.features.trackPrivateUsers'),
    t('onboarding.comparison.features.encryptedIG'),
    t('onboarding.comparison.features.redFlagBehavior'),
    t('onboarding.comparison.features.thirstTrapWarnings'),
    t('onboarding.comparison.features.followerFollowBackAlerts'),
  ];
  ...
  return (
    <View className="flex-1 px-4">
      <Text className="text-center font-roboto-extrablack text-4xl tracking-tighter">
        {t('onboarding.comparison.headline')}
      </Text>
      ...
      <View className="flex-1 justify-center">
        ...
        <View className="mb-4 flex-row items-center">
          <View className="flex-1">
            <Text className="font-roboto-bold text-xl">{t('onboarding.comparison.feature')}</Text>
          </View>
          <View className="w-20 items-center">
            <Text className="font-roboto-bold text-xl">{t('onboarding.comparison.other')}</Text>
          </View>
