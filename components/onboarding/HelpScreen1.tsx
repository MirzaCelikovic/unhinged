  ...
  return (
    <ScrollView className="flex-1" contentContainerStyle={{ flexGrow: 1 }} bounces={false}>
      <Text className="mt-4 px-4 text-center font-roboto-extrablack text-4xl tracking-tighter">
        {t('onboarding.helpScreen1.title')}
      </Text>
      ...
      <View className="px-4 pb-8">
        <Text className="text-center font-roboto-extrablack text-4xl">{t('onboarding.helpScreen1.subtitle')}</Text>
        <Text className="font-roboto mt-2 text-center text-base text-black">
          {t('onboarding.helpScreen1.body')}
        </Text>
        <View className="mt-6">
          <Button label={t('onboarding.helpScreen1.cta')} onPress={() => {
