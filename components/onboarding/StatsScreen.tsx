...
export default function StatsScreen({ onNext }: StatsScreenProps) {
  ...
  return (
    <View className="flex-1 px-4">
      ...
      <Text className="font-roboto mt-3 text-center text-base text-black">{t('onboarding.stats.subtitle')}</Text>
      ...
      <View className="flex-1 items-center justify-center">
        <View className="-mt-16 items-center justify-center">
          ...
          <View className="absolute items-center">
            ...
            <Text className="font-roboto text-lg text-black">{t('onboarding.stats.usersTracked')}</Text>
          </View>
        </View>
      </View>
