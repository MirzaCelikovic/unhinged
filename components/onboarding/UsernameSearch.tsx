...
export default function UsernameSearch({
    ...
    return (
      <ScrollView className="flex-1 px-4" contentContainerStyle={{ paddingBottom: 24 }}>
        ...
        <Text className="mb-3 mt-6 font-roboto-medium text-lg text-black">
          {t('onboarding.usernameSearch.notFollowingYouBack')}
        </Text>
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      setError(t('onboarding.usernameSearch.notFoundError'));
    } finally {
    ...
    <KeyboardAvoidingView
      ...
      <View className="flex-1 items-center justify-center px-4">
        ...
        <View className="mt-8 w-full">
          <TextField
            placeholder={t('onboarding.usernameSearch.usernamePlaceholder')}
            value={username}
