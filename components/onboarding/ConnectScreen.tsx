    ...
    <View className="flex-1 px-4">
      ...
      <View className="mt-3 flex-row items-center justify-center">
        ...
        <Text className="font-roboto ml-2 text-center text-base text-black">
          {t('onboarding.connect.secureSubtitle')}
        </Text>
      </View>
      ...
      <View className="mt-10 flex-1">
        <View className="mb-8 flex-row">
          ...
          <View className="ml-4 flex-1">
            <Text className="font-roboto-bold text-lg">{t('onboarding.connect.bankSecurityTitle')}</Text>
            <Text className="font-roboto mt-1 text-base text-black">
              {t('onboarding.connect.bankSecurityBody')}
            </Text>
          </View>
        </View>
        ...
        <View className="mb-8 flex-row">
          ...
          <View className="ml-4 flex-1">
            <Text className="font-roboto-bold text-lg">{t('onboarding.connect.secureLocalTitle')}</Text>
            <Text className="font-roboto mt-1 text-base text-black">
              {t('onboarding.connect.secureLocalBody')}
            </Text>
          </View>
        </View>
        ...
        <View className="flex-row">
          ...
          <View className="ml-4 flex-1">
            <Text className="font-roboto-bold text-lg">{t('onboarding.connect.discreetTitle')}</Text>
            <Text className="font-roboto mt-1 text-base text-black">
              {t('onboarding.connect.discreetBody')}
            </Text>
          </View>
        </View>
      </View>
      ...
      <View className="pb-8">
        <Pressable onPress={onConnect} className="w-full overflow-hidden rounded-3xl active:opacity-80">
          <View className="items-center justify-center">
            ...
            <Text className="absolute font-roboto-medium text-lg text-white">{t('onboarding.connect.connectButton')}</Text>
          </View>
        </Pressable>
