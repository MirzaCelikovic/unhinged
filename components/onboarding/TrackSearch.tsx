  ...
  if (savedResult) {
    return (
      <ScrollView className="flex-1 px-4" contentContainerStyle={{ paddingBottom: 24 }}>
        ...
        <Text className="mb-3 mt-6 font-roboto-medium text-lg text-black">{t('track.recentActivity')}</Text>
            ...
            <View key={account.id} className="overflow-hidden rounded-2xl">
              <View className="flex-row items-center gap-3 bg-white p-4">
                ...
                <View className="flex-1 justify-center">
                  ...
                  <Text className="font-roboto text-sm text-gray-400">{t(account.timeKey)}</Text>
                </View>
              </View>
            </View>
          ))}
