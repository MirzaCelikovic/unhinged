...
const INSIGHT_ROWS = [
  { labelKey: 'onboardingV2.reveal.insights.newFollowers', blurredValue: '24', locked: true },
  { labelKey: 'onboardingV2.reveal.insights.lastActivity', blurredValue: '3 hours ago', locked: true },
  { labelKey: 'onboardingV2.reveal.insights.flaggedAccounts', blurredValue: '18', locked: true },
  { labelKey: 'onboardingV2.reveal.insights.mostActive', locked: false },
];
    ...
    <View className="flex-1">
      <ScrollView
        ...
        <Text className="mb-6 text-center font-roboto-extrablack text-3xl text-black">
          {t('onboardingV2.reveal.title', { username })}
        </Text>
        ...
        <Pressable
          ...
          <Text className="font-roboto-extrablack text-base" style={{ color: '#FF0000' }}>
            {t('onboardingV2.reveal.spotRedFlags')}
          </Text>
        </Pressable>
      </ScrollView>
      ...
      <View style={{ position: 'absolute', bottom: 0, left: 0, right: 0 }} pointerEvents="box-none">
        <LinearGradient
          ...
          <Button label={t('onboardingV2.reveal.showMeEverything')} onPress={handleContinue} />
