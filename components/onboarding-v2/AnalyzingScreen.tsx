...
const CHECKLIST_KEYS = [
  'onboardingV2.analyzing.checklist.pulling',
  'onboardingV2.analyzing.checklist.mapping',
  'onboardingV2.analyzing.checklist.crossChecking',
  'onboardingV2.analyzing.checklist.matching',
  'onboardingV2.analyzing.checklist.validating',
];

const REVIEWS = [
  {
    image: require('~/assets/profile_1.jpg'),
    quoteKey: 'onboardingV2.analyzing.review1.quote',
    name: 'Jake M',
  },
  {
    image: require('~/assets/profile_2.jpg'),
    quoteKey: 'onboardingV2.analyzing.review2.quote',
    name: 'Taylor S',
  },
  {
    image: require('~/assets/profile_0.jpg'),
    quoteKey: 'onboardingV2.analyzing.review3.quote',
    name: 'Jess K',
  },
];
    ...
    <View className="flex-1">
      <View className="flex-1 px-6 pt-2">
        ...
        <Text className="text-center font-roboto-extrablack text-3xl text-black">
          {t('onboardingV2.analyzing.titlePrefix')}{' '}
          <Text className="font-roboto-extrablack">@{username}</Text>
          {t('onboardingV2.analyzing.titleSuffix')}
        </Text>
