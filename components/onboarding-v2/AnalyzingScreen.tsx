...
const CHECKLIST_KEYS = [
  'onboardingV2.analyzingScreen.checklistItem1',
  'onboardingV2.analyzingScreen.checklistItem2',
  'onboardingV2.analyzingScreen.checklistItem3',
  'onboardingV2.analyzingScreen.checklistItem4',
  'onboardingV2.analyzingScreen.checklistItem5',
];

const REVIEWS = [
  {
    image: require('~/assets/profile_1.jpg'),
    quoteKey: 'onboardingV2.analyzingScreen.review1Quote',
    nameKey: 'onboardingV2.analyzingScreen.review1Name',
  },
  {
    image: require('~/assets/profile_2.jpg'),
    quoteKey: 'onboardingV2.analyzingScreen.review2Quote',
    nameKey: 'onboardingV2.analyzingScreen.review2Name',
  },
  {
    image: require('~/assets/profile_0.jpg'),
    quoteKey: 'onboardingV2.analyzingScreen.review3Quote',
    nameKey: 'onboardingV2.analyzingScreen.review3Name',
  },
];
    ...
    <View className="flex-1">
      <View className="flex-1 px-6 pt-2">
        ...
        <Text className="text-center font-roboto-extrablack text-3xl text-black">
          {t('onboardingV2.analyzingScreen.headlinePrefix')}{' '}
          <Text className="font-roboto-extrablack">@{username}</Text>
          {t('onboardingV2.analyzingScreen.headlineSuffix')}
        </Text>
            ...
            <Animated.View
              ...
              {redFlagsState === 'spinning' ? (
                ...
                <Text className="font-roboto-extrablack text-lg tracking-wider" style={{ color: '#FF0000' }}>
                  {t('onboardingV2.analyzingScreen.redFlagsFound')}
                </Text>
              )}
            </Animated.View>
          </Animated.View>
      ...
      <View className="px-4 pb-8">
        {analysisComplete && (
          <Animated.View entering={FadeIn.duration(500)}>
            <Button label={t('onboardingV2.analyzingScreen.continueCta')} onPress={onNext} />
          </Animated.View>
        )}
        {!analysisComplete && (
