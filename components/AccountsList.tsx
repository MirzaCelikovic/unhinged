  ...
  const handleFollow = async (accountId: string, username: string, profilePicUrl: string | null) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        Alert.alert(t('error.title'), result.error || t('follow.failed'));
      }
    } catch (error) {
      Alert.alert(t('error.title'), t('follow.failed'));
    } finally {
        ...
        onPress: async () => {
          ...
          try {
            ...
            if (result.success) {
              ...
              Alert.alert(t('error.title'), result.error || t('unfollow.failed'));
            }
          } catch (error) {
            Alert.alert(t('error.title'), t('unfollow.failed'));
          } finally {
            setLoadingAccountId(null);
          }
        },
