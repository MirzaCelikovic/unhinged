    ...
    <ScrollView className="flex-1" contentContainerStyle={{ flexGrow: 1 }}>
      <View className="flex-1 px-4 pb-8">
        ...
        <Text className="mb-8 mt-6 text-center font-roboto-extrablack text-4xl tracking-tighter">
          {t('components.trackConfirm.title')}
        </Text>
        ...
        <View className="mt-6 overflow-hidden rounded-2xl bg-white">
          ...
          <View className="border-b border-gray-100 p-4">
            <View className="flex-row items-center justify-between">
              <Text className="font-roboto-medium text-base text-gray-900">
                {t('components.trackConfirm.syncFollowing')}
              </Text>
              <Switch
            ...
            {followingWarn && (
              <Text className="mt-2 font-roboto-regular text-sm text-gray-400">
                {t('components.trackConfirm.rateLimitWarning')}
              </Text>
            )}
          </View>
          ...
          <View className="p-4">
            <View className="flex-row items-center justify-between">
              <Text className="font-roboto-medium text-base text-gray-900">
                {t('components.trackConfirm.syncFollowers')}
              </Text>
              <Switch
        ...
        <View className="mt-6">
          <Button
            label={t('components.trackConfirm.startButton')}
