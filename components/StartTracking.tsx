    ...
    <KeyboardAvoidingView
      ...
      <View
        ...
        <Text className="mt-6 px-2 text-center font-roboto-extrablack text-4xl tracking-tighter">
          {t('components.startTracking.title')}
        </Text>
        <View className="relative mt-8 w-full">
          <TextField
            placeholder={t('components.startTracking.usernamePlaceholder')}
            value={username}
        ...
        <Text className="font-roboto-regular mt-4 px-2 text-center text-sm text-gray-600">
          {t('components.startTracking.note')}
        </Text>
        <View className="mt-6 w-full">
          <Button
            label={t('components.startTracking.continueButton')}
            mode="next"
            loading={isLoading}
